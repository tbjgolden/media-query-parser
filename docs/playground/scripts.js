...
var _self =
  ...
  Prism = (function (e) {
      ...
      a = {
        ...
        util: {
          ...
          setLanguage: function (e, t) {
            (e.className = e.className.replace(new RegExp(n, "gi"), "")),
        ...
        hooks: {
          ...
          run: function (e, n) {
            var t = a.hooks.all[e];
            if (t && t.length > 0) for (var r, i = 0; (r = t[i++]); ) r(n);
          },
        },
        Token: i,
      };
        ...
        if (t.hasOwnProperty(f) && t[f]) {
          ...
          for (var [d, v] of h.entries()) {
            ...
            if (y && !v.pattern.global) {
              ...
              v.pattern = new RegExp(v.pattern.source, x + "g");
            }
            for (
    ...
    if (
      (g && ((a.filename = g.src), Object.hasOwn(g.dataset, "manual") && (a.manual = !0)),
      !a.manual)
    ) {
